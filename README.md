# gadgety - A simple eCommerce website

gadgety is an open-source **Next.js eCommerce frontend** project.  
...
1. Clone the repo
    ...
    ```bash
    git clone https://github.com/GreatStackDev/gadgety.git
    cd gadgety
    ```
...
Thanks to everyone who contributes to **gadgety**!